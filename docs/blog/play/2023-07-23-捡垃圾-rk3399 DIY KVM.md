...
![KVM-bios.jpg](https://imagebed.yfycloud.site/2025/12/68a9c106f3ca160610018160102ce85b.jpg)
...
![](https://imagebed.yfycloud.site/2025/12/5eb6aa6844cd4eca8fdfa6b61ee0b7cb.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/efd2bbdcd738607726be142b5b075dda.png)
...
- 安装驱动DriverAssitant_v4.5
- 打开 rk dev tools（AndroidTool.exe）

1. 板子 typeC 接口连接到电脑。
2. 按住 rst 旁边的一个按键（usb），然后接通电源。
3. rk dev tool 显示发现 Maskrom 设备
4. 0xcccccccc 选择loader，0x00000000 选择系统 img 镜像
5. 点击执行，右边会显示日志，等待下载完成

坑

- 自己之前保留的刷机工具，打开包含很多地址，需要自己删除设置地址表
- 自己的工具，到最后一步下载时就会报错（loader 版本显示 1.1a（1.27.126））。使用这里下载的就没问题（loader 显示 1.26 （1.26.126），操作步骤一样。[King3399/荣品3399刷机教程 - 心语博客 (vpset.com)](https://vpset.com/9.html)
...
![](https://imagebed.yfycloud.site/2025/12/5e17806f906b124db26f74a3bf24a823.png)
...
![rockchip boot](https://imagebed.yfycloud.site/2025/12/63f11df92aced9b5ecc2d7ec6edc09a7.jpg)
...
```
armbian-apt   # 切换源，国内清华源需要把 /ubuntu 改为 /ubuntu-ports 否则 apt update 会有 404 链接
armbian-software  # `docker 镜像`、`桌面软件`、`应用服务`
armbian-swap 1   # 1G swap
```
...
![](https://imagebed.yfycloud.site/2025/12/61bdb024cd2de6c765e74753087c44db.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/93edb656381bc5735933ad5e7c1d7c68.png)

这是华硕 ROG Strix X570 的手册内容
![image.png](https://imagebed.yfycloud.site/2025/12/444bf9d1a772e2dc98463bdc1fb01864.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/a4224dd28657cf261461bc5b2c8401f2.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/87dda7f39be48578813f4c16dcad9288.png)
...
主板 GPIO 转 usb
![image.png](https://imagebed.yfycloud.site/2025/12/dd38e4bb049a2095e59e4141591e4492.png)

usb 接光耦继电器接 ATX PWR 引脚
![image.png](https://imagebed.yfycloud.site/2025/12/2de8f6c92b6d3b0b8554321242a30be0.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/8833209d7f6130e63c9e52bbce36e1d5.png)
...
[king3399 LTE module don't work · Issue #2565 · ophub/amlogic-s9xxx-armbian](https://github.com/ophub/amlogic-s9xxx-armbian/issues/2565)
[king3399的USBhub无法使用 · Issue #1225 · ophub/amlogic-s9xxx-armbian](https://github.com/ophub/amlogic-s9xxx-armbian/issues/1225#issuecomment-1644265175)
