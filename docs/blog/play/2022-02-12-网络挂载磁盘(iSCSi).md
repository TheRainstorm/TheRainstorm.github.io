...
![image.png](https://raw.githubusercontent.com/TheRainstorm/.image-bed/main/20250607100355.png)

发现原因在于 SB winddows 不支持目标名中包含大写字母。改为 iqn.2025-06.com.saturn:01-pc-game 即可

#### 由于会话上的某个设备当前正在使用，因此无法注销该会话

![image.png](https://raw.githubusercontent.com/TheRainstorm/.image-bed/main/20250608095203.png)

最 SB 的问题，以前用 iSCSI 就是因为这个问题而体验极差。

现在发现了解决办法，在设备管理器中，把虚拟磁盘卸载即可断开连接。
![image.png](https://raw.githubusercontent.com/TheRainstorm/.image-bed/main/20250608102019.png)
