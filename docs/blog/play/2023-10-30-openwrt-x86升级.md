...
make image \
PACKAGES="luci -dnsmasq dnsmasq-full bash zsh vim-full tmux git git-http htop tcpdump mtr-json curl wget ip-full iperf3 ss bind-dig tree file qrencode conntrack luci-app-ddns luci-app-upnp luci-app-wireguard wireguard-tools kmod-wireguard luci-proto-gre gre kmod-gre kmod-gre6 adguardhome zerotier python3" \
FILES="files"
