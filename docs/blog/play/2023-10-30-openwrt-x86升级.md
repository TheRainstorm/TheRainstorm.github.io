...
make image \
PACKAGES="luci -dnsmasq dnsmasq-full bash zsh vim-full tmux python3 git git-http htop tcpdump mtr-json curl ip-full iperf3 ss bind-dig tree file qrencode conntrack luci-app-wireguard wireguard-tools kmod-wireguard luci-proto-gre gre kmod-gre kmod-gre6 luci-app-ddns luci-app-upnp adguardhome zerotier " \
FILES="files"
