...
![](https://imagebed.yfycloud.site/2025/12/cdbd3ab8774f308620d3acba8e92d4b5.png)
...
![image-20220727184958311](https://imagebed.yfycloud.site/2025/12/6ffeda89201d9155790365398ac71fea.png)
...
![image-20220727190841956](https://imagebed.yfycloud.site/2025/12/09982560b1fbb09860520e1c21bb2778.png)

![image-20220727191456889](https://imagebed.yfycloud.site/2025/12/be852a1a0e6c4a3567e2ac73d8833c49.png)

![image-20220727191512098](https://imagebed.yfycloud.site/2025/12/369fa539c41638eeb701855edd8aa4be.png)
...
![image-20220727192028818](https://imagebed.yfycloud.site/2025/12/a40b6bf23950d2219788a47acf1470f8.png)
...
![image-20220727193931062](https://imagebed.yfycloud.site/2025/12/3aed0ce69a037ebb803f646504904edc.png)

![image-20220727193507768](https://imagebed.yfycloud.site/2025/12/f0a70592263b77e5e655c4698cad0dbe.png)
...
![image-20220727194059694](https://imagebed.yfycloud.site/2025/12/ae6a9daa302212d9c1fc35ec05220995.png)

##### set

![image-20220727194325976](https://imagebed.yfycloud.site/2025/12/79b634dc48728c83a74f363e35694877.png)
...
![image-20220727202131276](https://imagebed.yfycloud.site/2025/12/03a070868c8e6ae525b0b3322fa0814f.png)

图 3-47 和图 3-48 给出了在浮点数和整数数据类型之间以及不同浮点格式之间进行转换的指令集合。

![image-20220727202807490](https://imagebed.yfycloud.site/2025/12/598cb2e87d4837fde449befa4a16e5a4.png)

- 最后的两行时 GCC 在 float 和 double 间转换的代码，没有使用基本的 vctsd2ss（有没有这条指令呢？）

![image-20220727203331930](https://imagebed.yfycloud.site/2025/12/86e218100d4acdc23bdd4abb0c66a0b0.png)
...
![image-20220727204128819](https://imagebed.yfycloud.site/2025/12/0316f8bbea8197763b24265c2495636b.png)

- 浮点运算指令无法使用立即数。编译器必须为所有的常量值分配和初始化存储空间

![image-20220727204247797](https://imagebed.yfycloud.site/2025/12/53561c6d3c8e15c3ee21d87eb7da12cb.png)

##### 位级操作

![image-20220727204906712](https://imagebed.yfycloud.site/2025/12/623cfd96c942a6cad72cfa2a779b8763.png)

##### 比较

![image-20220727205010011](https://imagebed.yfycloud.site/2025/12/4d813c4a190acef98a95bf2bf46d7b6d.png)

- 浮点比较指令会设置三个条件码：零标志位 ZF，进位标志位 CF 和奇偶标志位 PF
  - 对于浮点比较，当两个操作数中任一个是 NaN 时，会设置 PF 位。
  - 当 x 为 NaN 时，比较 x==x 会得到 0

![image-20220727205538097](https://imagebed.yfycloud.site/2025/12/0592b2eb3d8556bcfc69765cc75a9501.png)
