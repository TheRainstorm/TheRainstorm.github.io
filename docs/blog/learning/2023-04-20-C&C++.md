...
- 注意：int -> unsigned
![](https://imagebed.yfycloud.site/2025/12/344f29287f26a278193472d014247108.png)
...
[(99 封私信 / 41 条消息) C++头文件里的内联函数加不加static有什么区别？ - 知乎](https://www.zhihu.com/question/592123672)

现在C++ inline关键字已经与传统“内联”含义完全无关。现在 inline 的作用就是允许其修饰对象（变量，函数等）重复定义，最后生成的时候具体使用哪个由链接器决定。

- static 可以使用匿名 namespace 实现
- 真正的内联可以使用 `__attribute__((always_inline))`
...
![](https://imagebed.yfycloud.site/2025/12/b069907007fa5e5c7262ce0de0075b68.png)
...
![](https://imagebed.yfycloud.site/2025/12/ce1efbbff94015c50ba871f614869a0e.png)
...
![](https://imagebed.yfycloud.site/2025/12/d0309d6f15d452db91fa9def5982c34b.png)
...
- normailized: exp 不全为 0 或 1
  - 全 0
![](https://imagebed.yfycloud.site/2025/12/72e33ba6d4f676da40e3534f03149009.png)
