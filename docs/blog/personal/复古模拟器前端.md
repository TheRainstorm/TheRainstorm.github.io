...
![image.png](https://imagebed.yfycloud.site/2025/12/d9f4873e329371e004fc5073ee7e4780.png)
![屏幕截图(118).png](https://imagebed.yfycloud.site/2025/12/46b19dd7d049ce8efcfb256b1d4ab1a6.png).png)
...
![retroarch-手柄快捷键.png](https://imagebed.yfycloud.site/2025/12/bb01b3e55f1d3896a708ae348b828bea.png)

Settings > Input > Port 1 Controls > Set All Controls and follow the prompts.
Settings > Input > Hotkeys

![](https://imagebed.yfycloud.site/2025/12/5aab2b65712f9cba1a38078d38a57cfd.png)
...
![image.png](https://imagebed.yfycloud.site/2025/12/25c6a7cf0ca3e677771a6de6f59312ec.png)
...
[近3TB容量的天马G怀旧模拟器整合包，NAS不知道装些啥的可以看看 - 知乎](https://zhuanlan.zhihu.com/p/707930876)

## 天马G 极速版

**极速版并不是精简不完整的意思，而是指优化了启动速度。**

### 下载

网上能找到各种各样的链接，如百度、夸克等，内容参差不齐。其实官方 B 站发布视频简介就有链接，包含完整内容。

- 安卓前端
  - [天马G 安卓端 极速版 1秒载入 正式发布_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1wB4gzHExz)
    - 天马G 极速版前端 链接: <https://pan.baidu.com/s/1IUZFkrtF3flEfWb6_WoUqA?pwd=TKLM>
- PC 前端
  - 20251108：[天马G PC端 极速版 1秒载入 前端/主题/滤镜/模拟器更新](https://www.bilibili.com/video/BV1y719BzEhN)
    - 22G 还包含一部分游戏 rom

#### rom

1. （2023）最早发布的完整包 2.8T
    - 所有 rom 有加密
2. （202511）极简包V1（174G）
3. 精简包V2（325G）
4. 街机 V3 （22G）
