...
- Official container image: `jellyfin/jellyfin` [![Docker Pull Count](https://img.shields.io/docker/pulls/jellyfin/jellyfin.svg)](https://imagebed.yfycloud.site/2025/12/d5ce8c26fb013bd7d2c07344bf421461.).
- LinuxServer.io image: `linuxserver/jellyfin` [![Docker Pull Count](https://img.shields.io/docker/pulls/linuxserver/jellyfin.svg)](https://imagebed.yfycloud.site/2025/12/cb220029eaf9fb7d59359d3418a74f27.).
- hotio image: `hotio/jellyfin` [![Docker Pull Count](https://img.shields.io/docker/pulls/hotio/jellyfin.svg)](https://imagebed.yfycloud.site/2025/12/6eedc527b94166034a0c18af49b13df8.png).
